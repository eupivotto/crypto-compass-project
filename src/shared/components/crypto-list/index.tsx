  ...
  return (
    <>
      <div className="container mx-auto">
        <h1 className=" text-white text-2xl font-bold mt-6 mb-8 ms-10">
          Top 10 Criptomoedas{" "}
          <span className="text-gray-500">por capitalização de mercado</span>
        </h1>
            ...
            >
              <div className="p-4 border-none rounded-lg shadow-lg bg-gray-800 text-white w-52">
                ...
                <div>
                  ...
                  <HigthLowIndicator
                    changePercentage={crypto.market_cap_change_percentage_24h}
                  />
                </div>
              </div>
            </Link>
